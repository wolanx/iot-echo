...
// connect to the serial port if it is not connected. Caller must hold the mutex.
...
// close the serial port if it is connected. Caller must hold the mutex.
